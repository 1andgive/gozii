...
def check_captions(caption_generator, dataloader,Dict_qid2vid, vocab,save_fig_loc,x_method_, t_method_, s_method_, args_):
    ...
    for v, b, q, i in iter(dataloader):
        ...
        with torch.no_grad():
            ...
            #print(args.isUnion)
            generated_captions, logits, att, encoded_feats, Vmat = caption_generator.generate_caption_n_context(v, b, q, obj_nums=num_objs, t_method=t_method_, x_method=args.x_method, s_method=s_method_,
